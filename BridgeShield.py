...
from models.BridgeShield import BridgeShield
...
def train(data_path: str, model_args: dict, **kwargs):
    ...
    for fold, (train_idx, valid_idx) in enumerate(kf.split(dataset)):
        ...
        for data in train_loader:
            ...
            if data.label is None or len(data.label) == 0:
                print("Warning: data.label is None or empty!")
                continue
        ...
        with torch.no_grad():
            ...
            save_classification_report("Ours", report_dict, "./result/BridgeShield.csv")
            model.eval()
